...
WebUI.click(findTestObject('Object Repository/login/Page_STORE/a_Log in'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/login/Page_STORE/a_Log out'), 0)
